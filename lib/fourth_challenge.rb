fourth_challenge[:montague][:hero_friends] = [{name: "Benvolio", age: " 17", attitude: "worried"}, {name: "Mercutio", age: "18", attitude: "hot-headed"}]

fourth_challenge[:capulet][:heroine_friends] = [{name: "Steven", age: "30", attitude: "confused"}, {name: "Nurse", age: "44", attitude: "worried"}]
